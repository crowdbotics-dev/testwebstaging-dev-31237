...
## Project Structure
    ...
    ├── testwebstaging_dev_31237  # Django project configurations
...
1. Clone this repo and `cd testwebstaging_dev_31237`
...
2. Clone this repo and `cd testwebstaging_dev_31237`
